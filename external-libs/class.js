 ...
 * @function {g3.Class}
 * @public
 * @param {String} 'classPath' is the second important argument: defines the 
 * namespace of the class.
 * @param {Object} 'classDefinition' is an object with the following members:
 * - The 'initialize' method will become the new class constructor,
 ...
 * - All other methods of this argument will become prototypal methods with one 
 *   exception: the behaviour of property 'STATIC'.
 * - Property 'STATIC' is an object with members (properties, functions) that 
 *   will be attached to the 'constructor' function as static members. Should  
 *   note that duplicates from parent are overwriten.
 * - Special static property 'Super': access the parent constructor with
 *   'classPath.Super.call(this, arg1, arg2, ...)' and every parent's method 
 *   with 'classPath.Super.prototype.method.call(this, arg1, arg2, ...)'.
 * - The 'Extends' property should have as value the 'classPath' of another 
 *   class which will become the parent of this one: all public members of the 
 *   parent declared with 'this' and prototypal ones are inhereted to the new 
 *   class. Also, all static members of parent are passed to this class as 
 *   static too.
 * - Property 'Implements' is an array of classes-namespaces that will borrow 
 *   their prototypal members to the new class resulting in object mixins.
 * @param {Boolean} 'local' if true will avoid to attache the class to the 
 * global namespace (window in case of a browser).
 * @return {Function} A constructor function.
 *
 * @version 0.1
 * @author https://github.com/DominikGuzei/Class.js
...
(function (globalNamespace) {
  ...
  // expose on global namespace like window (browser) or exports (node)
    ...
    /** @expose */
    globalNamespace['g3'] = globalNamespace['g3'] || {};
    globalNamespace['g3']['Class'] = Class;
  }
